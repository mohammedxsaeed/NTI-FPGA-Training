...
REM
REM Generated by Vivado on Sat Jul 11 22:42:28 +0300 2026
...
echo "xvlog --incr --relax -prj driver_test_vlog.prj"
call xvlog  --incr --relax -prj driver_test_vlog.prj -log xvlog.log
