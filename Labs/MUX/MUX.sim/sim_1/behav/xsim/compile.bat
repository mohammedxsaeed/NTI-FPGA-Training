...
REM
REM Generated by Vivado on Sat Jul 11 22:26:03 +0300 2026
...
echo "xvlog --incr --relax -prj multiplexor_test_vlog.prj"
call xvlog  --incr --relax -prj multiplexor_test_vlog.prj -log xvlog.log
