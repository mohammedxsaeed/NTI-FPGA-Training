...
REM
REM Generated by Vivado on Sat Jul 25 03:48:03 +0300 2026
...
echo "xvlog --incr --relax -prj edge_detectors_tb_vlog.prj"
call xvlog  --incr --relax -prj edge_detectors_tb_vlog.prj -log xvlog.log
