...
HD_PWD='D:/ECE/FPGA Training NTI/Register_LAB7/Register_LAB7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log register_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source register_test.tcl
