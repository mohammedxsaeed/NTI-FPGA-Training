...
HD_PWD='D:/ECE/FPGA Training NTI/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log param_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source param_memory.tcl
