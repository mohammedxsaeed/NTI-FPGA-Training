...
REM
REM Generated by Vivado on Mon Jul 13 22:13:39 +0300 2026
...
echo "xvlog --incr --relax -prj P_ENC_tb_vlog.prj"
call xvlog  --incr --relax -prj P_ENC_tb_vlog.prj -log xvlog.log
