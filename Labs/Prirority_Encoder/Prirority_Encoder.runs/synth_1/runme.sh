...
HD_PWD='D:/ECE/FPGA Training NTI/Prirority_Encoder/Prirority_Encoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log P_ENC_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source P_ENC_tb.tcl
