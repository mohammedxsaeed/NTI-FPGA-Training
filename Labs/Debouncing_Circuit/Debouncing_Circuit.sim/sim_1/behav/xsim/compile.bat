...
REM
REM Generated by Vivado on Sat Jul 25 03:28:21 +0300 2026
...
echo "xvlog --incr --relax -prj debouncing_circuit_tb_vlog.prj"
call xvlog  --incr --relax -prj debouncing_circuit_tb_vlog.prj -log xvlog.log
