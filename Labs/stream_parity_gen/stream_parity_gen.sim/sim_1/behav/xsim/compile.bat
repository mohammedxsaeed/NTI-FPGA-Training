...
REM
REM Generated by Vivado on Sat Jul 25 04:20:21 +0300 2026
...
echo "xvlog --incr --relax -prj stream_parity_gen_tb_vlog.prj"
call xvlog  --incr --relax -prj stream_parity_gen_tb_vlog.prj -log xvlog.log
