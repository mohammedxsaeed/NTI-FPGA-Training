...
REM
REM Generated by Vivado on Wed Jul 22 20:06:49 +0300 2026
...
echo "xvlog --incr --relax -prj seq_detector_TB_vlog.prj"
call xvlog  --incr --relax -prj seq_detector_TB_vlog.prj -log xvlog.log
