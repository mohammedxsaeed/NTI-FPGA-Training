...
HD_PWD='D:/ECE/FPGA Training NTI/Controller_LAB6/Controller_LAB6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log controller_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source controller_test.tcl
