...
REM
REM Generated by Vivado on Mon Jul 13 17:59:58 +0300 2026
...
echo "xvlog --incr --relax -prj controller_test_vlog.prj"
call xvlog  --incr --relax -prj controller_test_vlog.prj -log xvlog.log
