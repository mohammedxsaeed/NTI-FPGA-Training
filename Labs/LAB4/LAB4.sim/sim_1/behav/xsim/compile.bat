...
REM
REM Generated by Vivado on Sat Jul 25 06:34:17 +0300 2026
...
echo "xvlog --incr --relax -prj TOP_SYSTEM_tb_vlog.prj"
call xvlog  --incr --relax -prj TOP_SYSTEM_tb_vlog.prj -log xvlog.log
